...
public struct History: Equatable {
    ...
    public func recording(_ payload: Payload, from sourceApp: String?, at date: Date, id: UUID = UUID()) -> History {
        var next = self
        ...
        let item = ClipboardItem(id: id, payload: payload, sourceApp: sourceApp, copiedAt: date, isPinned: false)
